...
_u16 StackSize(const Stack_t* stack) { return stack->size; }

_u16 StackCapacity(const Stack_t* stack) { return stack->capacity; }
...
bool StackIsEmpty(const Stack_t* stack) { return stack->size == 0; }